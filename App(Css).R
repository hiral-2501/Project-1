...
ui <- fluidPage(
  ...
  tags$head(
    tags$style(HTML("
      ...
      body {
        background-color: #f0f8f5; /* light forest green background */
        font-family: 'Poppins', sans-serif;
        color: #2e4d38; /* darker forest green text */
      }
      ...
      h3 {
        text-align: center;
        font-weight: 700;
        color: #1b4332; /* Deep forest green heading */
        margin-bottom: 20px;
      }
      ...
      .btn-primary:hover {
        background-color: #40916c; /* lighter on hover */
  ...
  mainPanel(
    ...
    wellPanel(
      ...
      helpText("How would you rate your sleep on an average daily basis from 0 (poor) to 100 (excellent)?")
    )
  ),
